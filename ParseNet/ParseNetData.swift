...
class ParseNetData {
    ...
    var fc7_nor_scale_w: UnsafeMutablePointer<Float> { return ptr + 3196032 }
    var pool6_nor_scale_w: UnsafeMutablePointer<Float> { return ptr + 3197056 }
    
    var fc7_nor_score18_w: UnsafeMutablePointer<Float> {return ptr + 3198080}
    var fc7_nor_score18_b: UnsafeMutablePointer<Float> {return ptr + 3216512}
    var pool6_nor_score18_w: UnsafeMutablePointer<Float> { return ptr + 3216530 }
    var pool6_nor_score18_b: UnsafeMutablePointer<Float> { return ptr + 3234962 }
