...
public class MobileNet {
    ...
    public init(device: MTLDevice) {
        ...
        guard let path = Bundle.main.path(forResource: "mobile_weights", ofType: "bat"),
        ...
        t1 = EltwiseKernel(device: device,featureChannels:32) //for test
...
//            let conv2_1dw_img = MPSImage(device: device, imageDescriptor: conv2_1dw_id)
            ...
            print(conv1_s2_img.toFloatArray()[100176...100186])
